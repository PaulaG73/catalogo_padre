<template>
    <footer class="footer footer-vino--light py-2 py-md-4 border-top">
      <div class="container footer-inner">
        <div class="footer-actions">
          ...
          <a
            class="btn btn-whatsapp wa-cta wa-cta--footer shadow-sm"
            :href="whatsappUrl"
            target="_blank"
            ...
            aria-label="Haz aquí un pedido a tu medida por WhatsApp"
          >
            <svg class="wa-cta-icon" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <span class="wa-cta-text">Haz aquí un pedido a tu medida!</span>
          </a>
        </div>
  ...
  .footer-actions :deep(.wa-cta--footer) {
    flex-shrink: 1;
    min-width: 0;
    max-width: 100%;
    align-self: center;
