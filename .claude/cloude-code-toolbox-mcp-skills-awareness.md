...
Workspace `mcp.json` _(folder: catalogo_padre)_

- **c:\Users\paula\OneDrive\Desktop\Bootcamp_Frontend_2025\MÓDULO_7\catalogo_padre\.vscode\mcp.json** — _File missing_
